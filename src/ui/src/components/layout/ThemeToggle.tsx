...
//
// One button that CYCLES the theme: dark → light → pastel → dark. Following the
// common affordance, it shows the icon of the theme it will switch TO (a sun in
// dark mode → "go light"; a palette in light mode → "go pastel"; a moon in pastel
// mode → "go dark"). The store mutator applies the <html> class and persists, so
...
const NEXT_ICON = { dark: Sun, light: Palette, pastel: Moon } as const;
const NEXT_LABEL = {
  dark: 'Switch to light theme',
  light: 'Switch to pastel theme',
  pastel: 'Switch to dark theme',
} as const;
const NEXT_TITLE = { dark: 'Light mode', light: 'Pastel mode', pastel: 'Dark mode' } as const;
